...
This document provides guidance for implementing and maintaining secure coding controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
...
- [ISO/IEC 27001:2022](https://www.iso.org/standard/27001) - Information Security Management Systems - Requirements (Control A.8.28)
- [ISO/IEC 27002:2022](https://www.iso.org/standard/75652.html) - Information Security Controls - Section 8.28: Secure Coding
- [NIST SP 800-53 Rev. 5](https://csrc.nist.gov/publications/detail/sp/800-53/rev-5/final) - SA-11: Developer Security Testing, SA-15: Development Process
- [OWASP Secure Coding Practices](https://owasp.org/www-project-secure-coding-practices-quick-reference-guide/) - Quick Reference Guide
- [CWE/SANS Top 25](https://cwe.mitre.org/top25/) - Most Dangerous Software Errors
- [CERT Secure Coding Standards](https://wiki.sei.cmu.edu/confluence/display/seccode) - SEI Carnegie Mellon
- [CIS Controls v8](https://www.cisecurity.org/controls/v8) - Control 16.3: Perform Root Cause Analysis on Security Vulnerabilities
- [OWASP Code Review Guide](https://owasp.org/www-project-code-review-guide/) - Secure Code Review
- [Microsoft: Secure Coding Guidelines](https://docs.microsoft.com/en-us/dotnet/standard/security/secure-coding-guidelines) - .NET Security
- [PCI DSS v4.0](https://www.pcisecuritystandards.org/) - Requirement 6.2.4: Secure Coding Practices
- [SOC 2 Trust Services Criteria](https://us.aicpa.org/interestareas/frc/assuranceadvisoryservices/aicpasoc2report) - CC8.1: Secure Coding
- [SAFECode: Practical Security Stories](https://safecode.org/) - Software Security Best Practices
