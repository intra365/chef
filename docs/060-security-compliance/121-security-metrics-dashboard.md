...
**Control**: KPIs and security metrics

## Overview

This document provides guidance for implementing and maintaining security metrics dashboard controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
