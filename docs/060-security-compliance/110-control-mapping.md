...
**Control**: Mapping controls to existing security measures

## Overview

This document provides guidance for implementing and maintaining iso 27001 control mapping controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
