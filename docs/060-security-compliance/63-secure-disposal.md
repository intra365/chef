...
**Control**: A.7.14 - Secure disposal

## Overview

This document provides guidance for implementing and maintaining secure disposal or re-use of equipment controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
