...
**Control**: A.8.21 - Network services security

## Overview

This document provides guidance for implementing and maintaining security of network services controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
