...
**Control**: Template for identifying compliance gaps

## Overview

This document provides guidance for implementing and maintaining gap analysis template controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
