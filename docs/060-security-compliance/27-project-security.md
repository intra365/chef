...
**Control**: A.5.8-A.5.18 - Project and change management security

## Overview

This document provides guidance for implementing and maintaining information security in project management controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
