...
**Control**: A.7.9 - Off-premises assets

## Overview

This document provides guidance for implementing and maintaining security of assets off-premises controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
