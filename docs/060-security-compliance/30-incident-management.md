...
**Control**: A.5.24-A.5.28 - Security incident management

## Overview

This document provides guidance for implementing and maintaining information security incident management controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
