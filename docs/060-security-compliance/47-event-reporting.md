...
**Control**: A.6.8 - Event reporting

## Overview

This document provides guidance for implementing and maintaining information security event reporting controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
