...
This document provides guidance for implementing and maintaining application security requirements controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
