...
**Control**: A.5.19-A.5.22 - Supplier security

## Overview

This document provides guidance for implementing and maintaining information security in supplier relationships controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
