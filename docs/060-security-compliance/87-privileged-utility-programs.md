...
**Control**: A.8.18 - Privileged utility programs

## Overview

This document provides guidance for implementing and maintaining use of privileged utility programs controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
