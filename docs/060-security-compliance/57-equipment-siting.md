...
**Control**: A.7.8 - Equipment siting

## Overview

This document provides guidance for implementing and maintaining equipment siting and protection controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
...
- [ISO/IEC 27001:2022](https://www.iso.org/standard/27001) - Information Security Management Systems - Requirements (Control A.7.8)
- [ISO/IEC 27002:2022](https://www.iso.org/standard/75652.html) - Information Security Controls - Section 7.8: Equipment Siting and Protection
- [NIST SP 800-53 Rev. 5](https://csrc.nist.gov/publications/detail/sp/800-53/rev-5/final) - PE-18: Location of System Components
- [TIA-942](https://www.tiaonline.org/standards/) - Data Center Equipment Location Standards
- [ASHRAE TC 9.9](https://tc0909.ashraetcs.org/) - Thermal and Environmental Guidelines for IT Equipment
- [Uptime Institute: Data Center Site Infrastructure](https://uptimeinstitute.com/) - Equipment Placement Best Practices
- [IEC 60529](https://webstore.iec.ch/publication/2452) - IP Code - Degrees of Protection
- [NEMA Standards](https://www.nema.org/) - Enclosure Types for Electrical Equipment
- [SOC 2 Trust Services Criteria](https://us.aicpa.org/interestareas/frc/assuranceadvisoryservices/aicpasoc2report) - CC6.4: Equipment Protection
- [BICSI: Equipment Installation Guidelines](https://www.bicsi.org/) - Infrastructure Design Standards
