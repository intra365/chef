...
**Control**: A.8.14 - Redundancy

## Overview

This document provides guidance for implementing and maintaining redundancy of information processing facilities controls for the Intra365 platform in accordance with ISO 27001:2022 requirements.
